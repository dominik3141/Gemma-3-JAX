...
Queued resources requests for some reason stay around after they have been fulfilled. And since we always use the same name, we first have to check if there is still one existing and delete that one.
